...
def append_hgcalLayerClustersPlots(collection = "hgcalLayerClusters", name_collection = layerClustersLabel, extended = False):
  ...
  regions_CellLevel          = ["General: Cell Level", "Z-minus: Cell Level", "Z-plus: Cell Level"]
  ...
  setPlots_CellLevel          = [plots_lc_general_cellevel, plots_lc_cellevel_zminus, plots_lc_cellevel_zplus]
